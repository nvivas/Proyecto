...
public class Tareas_despiece {
    ...
    public void insertarCostado(int cont, int altoCostado, int fondoCostado, final int GRUESO) {
        String sql;
        // -------------------  Añadir costado -----------------------------------
    ...
    public void insertarAparador(int cont, int anchoAparador, int fondoCostado, final int GRUESO) {
        String sql;
        // -------------------  Añadir costado -----------------------------------
        PreparedStatement consulta = null;
        sql = "insert into despiece value (?,?,?,?,?)";
    ...
    public void insertarPuerta(int cont, int altoPuerta, int anchoPuerta, final int GRUESO) {
        String sql;
        // -------------------  Añadir costado -----------------------------------
        PreparedStatement consulta = null;
        sql = "insert into despiece value (?,?,?,?,?)";
    ...
    public void insertarTrasera(int cont, int altoPuerta, int anchoPuerta, final int GRUESO10) {
        String sql;
        // -------------------  Añadir costado -----------------------------------
        PreparedStatement consulta = null;
        sql = "insert into despiece value (?,?,?,?,?)";
    ...
    public void insertarZocalo(int cont, int anchoAparador, int fondoZocalo, final int GRUESO30) {
        String sql;
        // -------------------  Añadir costado -----------------------------------
        PreparedStatement consulta = null;
        sql = "insert into despiece value (?,?,?,?,?)";
