...
public class Tareas_color {
    ...
    public int darAlta(ColorTablero tablero) {
        ...
        ResultSet ts = null;
        String sql = "INSERT INTO color(nombre_color, largo, ancho, proveedor_id_proveedor, grueso) "
                + "VALUES (?,?,?,?,?)";
        ...
        try {
            ...
            consulta.setInt(4, tablero.getId_proveedor());
    ...
    public ColorTablero modificarColor(ColorTablero tablero) throws SQLException {
        ...
        try {
            ...
            System.out.println("Modificar color TC");
            MensajeExcepcion(ex);
        }
    ...
    public List<ColorTablero> recuperarTodas() throws SQLException {
        ...
        try {
            ...
            System.out.println("Recuperar todas TC");
            MensajeExcepcion(ex);
        }
        return tablero;
    }

    public static ArrayList<String> llenar_combo_pro() {
        ...
        try {
            while (resultado.next()) {
                lista.add(resultado.getString("nombre_pro"));
            }
