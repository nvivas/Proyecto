...
public class ColorTablero {
    ...
    public ColorTablero(String color, Integer largo, Integer ancho, Integer grueso, List id_pro) {
        this.color = color;
        this.largo = largo;
        this.ancho = ancho;
        this.grueso = grueso;
    ...
    public ColorTablero(Integer id_proveedor) {
    ...
    public ColorTablero(String color, Integer largo, Integer ancho, Integer grueso, Integer id_proveedor) {
        this.color = color;
        this.largo = largo;
        this.ancho = ancho;
        this.grueso = grueso;
